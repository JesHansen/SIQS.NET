...
const string Usage = "usage: qs-linalg --meta matrix_meta.txt --matrix filtered_matrix.txt --relations relations_filtered.txt --out dependencies.txt [--telemetry linalg_telemetry.txt] [--max-dependencies N (1..64)] [--linalg-parallelism N] [--linalg-seed N]";
