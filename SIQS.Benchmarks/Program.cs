...
if (args is ["--compare-direct-sieve", ..])
{
    return DirectSieveComparisonTool.Run(args[1..]);
}

if (args is ["--compare-candidate-resieve", ..])
{
    return CandidateResieveComparisonTool.Run(args[1..]);
}
