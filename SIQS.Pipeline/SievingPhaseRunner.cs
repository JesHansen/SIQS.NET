...
internal sealed class SievingPhaseRunner
{
    public Task<PhaseResult> RunAsync(PhaseContext context) => Task.Run(() =>
    {
        ...
        var counterMap = new Dictionary<string, string>
        {
            ...
            ["spv_reports"] = counters.SmallPrimeVariationReports.ToString(),
            ["spv_rejected"] = counters.SmallPrimeVariationRejected.ToString(),
            ["spv_prime_count"] = counters.SmallPrimeVariationCount.ToString(),
            ["spv_allowance"] = counters.SmallPrimeVariationAllowance.ToString(),
            ["preliminary_reports"] = counters.PreliminaryReports.ToString(),
            ["exact_threshold_rejects"] = counters.ExactThresholdRejects.ToString(),
            ["direct_gated_candidate_blocks"] = counters.DirectGatedCandidateBlocks.ToString(),
            ["resieved_candidate_blocks"] = counters.ResievedCandidateBlocks.ToString(),
            ...
            ["cofactor_micro_ecm_attempts"] = counters.CofactorMicroEcmAttempts.ToString(),
            ["cofactor_micro_ecm_successes"] = counters.CofactorMicroEcmSuccesses.ToString(),
            ...
            [CounterKeys.UsableRelations] = counters.UsableRelations.ToString(),
            ...
            ["bucket_large_prime_cutoff"] = parameters.BucketLargePrimeCutoff.ToString(),
            ["resieve_large_prime_cutoff"] = parameters.ResieveLargePrimeCutoff.ToString(),
            ["small_prime_variation_bound"] = parameters.SmallPrimeVariationBound.ToString(),
            ...
            ["cpu_spv_ms"] = counters.SmallPrimeVariationCpuMs.ToString(),
            ["cpu_poly_eval_ms"] = counters.PolyEvalCpuMs.ToString(),
            ["cpu_known_hit_collection_ms"] = counters.KnownHitCollectionCpuMs.ToString(),
