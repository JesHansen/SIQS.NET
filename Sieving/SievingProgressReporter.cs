...
internal static class SievingProgressReporter
{
        ...
        int activeAFamilies)
    {
        var counterMap = new Dictionary<string, string>
        {
            ...
            [CounterKeys.UsableRelations] = approxUsable.ToString(),
    ...
    public static void Report(IProgress<SiqsProgressEvent>? progress, SievingCounters counters, string? current)
    {
        var counterMap = new Dictionary<string, string>
        {
            ...
            ["bucket_maximum_hits_per_bucket"] = counters.BucketMaximumHitsPerBucket.ToString(),
            ["bucket_capacity_per_bucket"] = counters.BucketCapacityPerBucket.ToString(),
